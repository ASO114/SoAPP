...
public final class JceDisplayer {
	...
	public <T> JceDisplayer display(Collection<T> v, String fieldName) {
		...
		/*
		 * ps(fieldName); if(v.isEmpty()){
		 * sb.append(v.size()).append(", []").append('\n'); return this; }
		 * sb.append(v.size()).append(", [").append('\n'); JceDisplayer jd = new
		 * JceDisplayer(sb, _level + 1); for(T o : v) jd.display(o, null);
		 * display(']', null); return this;
		 */
	}
	...
	public <T> JceDisplayer display(T o, String fieldName) {
		if (null == o) {
			...
			display((Map<Object, Object>) o, fieldName);
		} else if (o instanceof List) {
			display((List<Object>) o, fieldName);
